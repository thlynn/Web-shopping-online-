<%-- 
    Document   : home
    Created on : Oct 4, 2023, 8:14:14 PM
    Author     : dell
--%>
...
<html>
    ...
    <body>
        ...
        <div class="menu">
            <div class="list">
                <ul>
                    <li><a href="cid?cid=0">All</a></li>
                        <%
                                    DAO d = new DAO();
                                    List<Category> list = d.getAll();
                                    for(Category cate : list){
                        %>
                    <li><a href="cid?cid=<%=cate.getCategoryID()%>"><%=cate.getCategoryName()%></a></li>
                        <%
                            }
                        %>
                </ul>
            ...
            <div class="cart">
                <img src="image/cart.png" alt="alt"/><a href="login.jsp">My shopping cart items</a>
            </div>
        ...
        <div class="category">
            ...
            <div class="category-items">
                ...
                <div class="category-items-content">
                    ...
                    <p>Product Name: </br><%= p.getProductName() %></p>
