<%-- 
    Document   : admin
    Created on : Oct 24, 2023, 12:05:23 AM
    Author     : dell
--%>
    ...
    <body>
        ...
        <div class="menu">
            <div class="list">
                <ul>
                    ...
                    <li><a href="cid3?cid3=0">All</a></li>
                        <%
                                    DAO d = new DAO();
                                    List<Category> list = d.getAll();
                                    for(Category cate : list){
                        %>
                    <li><a href="cid3?cid3=<%=cate.getCategoryID()%>"><%=cate.getCategoryName()%></a></li>
            ...
            <div class="cart">
                <img src="image/cart.png" alt="alt"/><a href="allcart2">My shopping cart items</a>
            </div>

            <div class="identify">
                <p class="pa">${sessionScope.account.getCustomerName()}</p>
                <a class="avatar" href="avatar2.jsp"><img src="image/avatar.jpg" alt="alt"/></a>
                <a class="logout" href="cid?cid=0">Log out</a>
                <a class="addshop" href="AddProduct.jsp">Add to your shop</a>
            </div>
        </div>
        <%
        ...
        <div class="category">
            ...
            <div class="category-items">
                <a href="ProductID3?ProductID3=<%= p.getProductID() %>"><img src="<%= p.getImage() %>"/></a>
