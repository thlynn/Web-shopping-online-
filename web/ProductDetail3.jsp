<%-- 
    ...
    Created on : Oct 24, 2023, 12:24:01 AM
    Author     : dell
--%>
    ...
    <body>
        ...
        <div class="product-detail">
            ...
            <div class="product-detail-buying">
                ...
                <input type="number" id="quantity" name="quantity1" value="1" min="1" />
                <input type="hidden" id="name" name="productName1" value="<%= product.getProductName() %>" />
                <input type="hidden" id="price" name="price1" value="<%= product.getPrice() %>" />
                <hr/>
                <p class="content3">Tong tien phai thanh toan: 
                    <span id="total"><%= product.getPrice() %></span>
                </p>
                <button><a class="link" href="#" id="paymentLink">Thanh toan</a></button>
                <button><a class="link" href="#" id="cartLink">Them vao gio hang</a></button>
        ...
        <div class="footer">
            <a href="cid3?cid3=0">CONTINUE TO BACK HOME PAGE TO SHOPPING</a>
...
// Function to calculate and update the total
            function updateTotal() {
                ...
                paymentLink.href = "payment.jsp?productName=" + productName.value + "&quantity=" + quantity + "&price=" + total;
                cartLink.href = "cart.jsp?productName=" + productName.value + "&quantity=" + quantity + "&price=" + total;
            }
